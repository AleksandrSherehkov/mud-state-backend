...
describe('RefreshTokenService', () => {
  ...
  describe('create', () => {
    it('creates refresh token with provided params', async () => {
      prisma.refreshToken.create.mockResolvedValue({ id: 't1' });
    ...
    it('allows optional ip/userAgent', async () => {
      prisma.refreshToken.create.mockResolvedValue({ id: 't2' });
  ...
  describe('revokeByJti', () => {
    it('revokes token by jti', async () => {
      prisma.refreshToken.update.mockResolvedValue({ id: 't' });
  ...
  describe('revokeIfActive', () => {
    it('revokes only active token for user', async () => {
